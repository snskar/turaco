...
export const vanillaBirthdayCouple = {
    ...
    message: "Happy Birthday, legend! May your wrinkles be few, your snacks never end, and your group chats always spicy. Keep being fabulously weird—like glitter in a world full of beige!",
    
    photos: [
      { id: "photo-1", url: "/sample_photos/g_prime_1.jpg" },
      { id: "photo-2", url: "/sample_photos/g_prime_2.jpg" },
      { id: "photo-3", url: "/sample_photos/g_prime_3.jpg" },
      { id: "photo-4", url: "/sample_photos/g_prime_4.jpg" }
    ],
